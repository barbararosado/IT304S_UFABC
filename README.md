...
Para a análise da modulação, duas alternativas foram consideradas. A primeira através do ajuste da contratação horosazonal da energia em relação ao padrão de consumo das UCs. A outra através da contratação “flat”, dividindo-se o consumo diário pelas 24 horas do dia. 
